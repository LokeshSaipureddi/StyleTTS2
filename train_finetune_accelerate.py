...
def main(config_path):
    ...
    print(f"Data Lists are Loaded")
    print(f"Length of Train Samples are {len(train_list)}")
    print(f"Length of Validation samples are {len(val_list)}")
            ...
            if epoch >= diff_epoch:
                ...
                if multispeaker:
                    ...
                    loss_diff = model.diffusion(s_trg.unsqueeze(
                        # EDM loss
                        1), embedding=bert_dur, features=ref).mean()
