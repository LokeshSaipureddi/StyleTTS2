...
class TTS2Inference:
    ...
    def load_models(self, model_path):
        ASR_config = self.config['ASR_config']

        ASR_path = self.config['ASR_path']
        text_aligner = load_ASR_models(ASR_path, ASR_config)

        # load pretrained F0 model
        F0_path = self.config['F0_path']
        pitch_extractor = load_F0_models(F0_path)

        # load BERT model
        BERT_path = self.config['PLBERT_dir']
...
if __name__ == "__main__":
    synthesizer = TTS2Inference(
        config_path="/Users/lokeshsaipureddi/Documents/Python Projects/AI Voice App/StyleTTS2/Models/LibriTTS/config.yml",
        model_path="/Users/lokeshsaipureddi/Documents/Python Projects/AI Voice App/StyleTTS2/Models/LibriTTS/epochs_2nd_00020.pth"
    )

    ref_style = synthesizer.compute_style(
        "/Users/lokeshsaipureddi/Documents/Python Projects/AI Voice App/StyleTTS2/Data/wavs/output_17.wav")
    
    audio = synthesizer.inference(
        text="Hi, In this video, I'm planning to build an application. I am gonna check how is it going to work !!!",
        ref_s=ref_style,
        alpha = 0.3,
        beta = 0.7,
        diffusion_steps = 5,
    ...
    sf.write("norm_output.wav", audio, 24000)
